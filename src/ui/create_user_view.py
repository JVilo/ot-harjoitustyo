...
from services.pef_service import pef_service, UsernameExistsError, PasswordsDoNotMach
...
class CreateUserView:
    ...
    def _create_user_handler(self):
        ...
        try:
            pef_service.create_user(username, password)
            self._handle_create_user()

        except UsernameExistsError:
            self._show_error(f"Username {username} already exists")

        except PasswordsDoNotMach:
            self._show_error(f'Password does not match')
